...
<div class="databox">
  <form id="form1" name="form1" method="post" action="Bpro.php">
...
$PadamB = "<a href=\"/responsive/PadamB.php?i=$b_id &a=1\" onclick=\"return confirm('Padam')\">delete</a>";
$EditB = "<a href=\"/responsive/EditB.php?i=$b_id &a=2\" onclick=\"return confirm('Edit')\">edit</a>";




echo "<tr>";
echo "<td>$b_id </td><td>$Penempatan</td><td>$Tahun</td><td>$PadamB</td><td>$EditB</td></td>";
