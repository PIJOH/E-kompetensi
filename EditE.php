...
<div class="databox">
  ...
  <table width="auto" border="0" align="center" cellspacing="1" cellpadding="2">
  <?php
...
if(isset($_POST['update']))
{
    ...
    $sql ="UPDATE e SET Aktiviti = '$Aktiviti' WHERE e_id = $e_id";
...
else if(isset($_GET['a']))
{
    ...
    if($EditE = 2)
    {
        ...
        $sql = "SELECT * FROM e WHERE e_id = '$e_id'";
...
$Aktiviti = $row['Aktiviti'];
                ...
                echo'<form method = "POST" action="/responsive/EditE.php"">';
                echo"<strong>Kemaskini Maklumat</strong>";
                echo'<table align ="center" border="2">';
				
				echo"<tr><td>ID</td><td><input type='text' name ='e_id' size = '10' maxlength = '10' value = '$e_id' readonly></td></tr>";
  ?>  
  <tr>
