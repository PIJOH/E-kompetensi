...
<div class="databox">
  <form id="form1" name="form1" method="post" action="KursusPro.php">
 ...
 <table width="361" height="75" border="0" align="center" cellpadding="2" cellspacing="1">
  <tr>
    <td width="350">        	<input name="save" type="submit" class="StyleTxtField2" id="save" value="Save" onclick="msg()" />
        	<button onclick="location.href = 'Pensijilan.php' " type="button" class="StyleTxtField2">Back Page</button>
        	<button onclick="location.href = 'Salinan.php' " type="button" class="StyleTxtField2">Next Page</button></td>
  </tr>
</table>
