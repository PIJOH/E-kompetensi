...
<div class="databox">
  <form id="form1" name="form1" method="post" action="/responsive/KhidmatNasihatPro.php"><table width="auto" border="0" align="center" cellpadding="2" cellspacing="1">
  <tr>
  ...
  <tr>
    <td width="350">        	<input name="save" type="submit" class="StyleTxtField2" id="save" value="Save" />
        	<button onclick="location.href = 'KhidmatPerundingan.php' " type="button" class="StyleTxtField2">Back Page</button>
        	<button onclick="location.href = 'ProdukIlmiah.php' " type="button" class="StyleTxtField2">Next Page</button></td>
  </tr>
</table>
  </form>
...
$Padam6 = "<a href=\"/responsive/Padam6.php?i=$KhidmatNasihat_id&a=1\" onclick=\"return confirm('Padam')\">delete</a>";
$Edit6 = "<a href=\"/responsive/Edit6.php?i=$KhidmatNasihat_id&a=2\" onclick=\"return confirm('Edit')\">edit</a>";




echo "<tr>";
echo "<td>$NamaNasihat</td><td>$Kementerian</td><td>$Jabatan</td><td>$Bidang</td><td>$Jawatan</td><td>$Peringkat</td><td>$datepicker</td><td>$datepicker2</td><td>$DeskripsiDokumen</td><td>$Padam6</td><td>$Edit6</td></td>";
