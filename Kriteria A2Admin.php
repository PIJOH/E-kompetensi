...
<div class="databox">
  <form id="form1" name="form1" method="post" action="A2proAdmin.php">
  ...
  <tr>
    <td width="350">        	<input name="save" type="submit" class="StyleTxtField2" id="save" value="Save" onclick="msg()" />
        	<button onclick="location.href = 'Kriteria A1Admin.php' " type="button" class="StyleTxtField2">Back Page</button>
        	<button onclick="location.href = 'Kriteria A3Admin.php' " type="button" class="StyleTxtField2">Next Page</button></td>
  </tr>
</table>
</form>
</div>
...
$PadamA2Admin = "<a href=\"/responsive/PadamA2Admin.php?i=$a2_id &a=1\" onclick=\"return confirm('Padam')\">delete</a>";
$EditA2Admin = "<a href=\"/responsive/EditA2Admin.php?i=$a2_id &a=2\" onclick=\"return confirm('Edit')\">edit</a>";




echo "<tr>";
echo "<td>$a2_id </td><td>$Pensijilan</td><td>$Penglibatan</td><td>$Anugerah</td><td>$PadamA2Admin</td><td>$EditA2Admin</td></td>";
