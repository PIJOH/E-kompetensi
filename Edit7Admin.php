...
<div class="header">
 <div class="logo"></div>
  <div class="header2">
    ...
    <a href="/responsive/homeAdmin.php"><div class="homeicon"><div class="homeicon"><div class="welcome">Welcome!<?php echo '&nbsp'; echo '&nbsp';echo $FName; echo '&nbsp'; echo $LName; ?></div></div></a>
   	</nav>
