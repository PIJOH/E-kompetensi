  ...
  <tr class="w3-blue">
      ...
      <!-- populate table from mysql database -->
                ...
                <tr>
                    ...
                    <td><a href="/responsive/templateAdmin.php?userid=<?php echo $row['userid'] ?>">E-Kompetensi</a></td>
           <td><a href="/responsive/TemplateKecemerlanganAdmin.php?userid=<?php echo $row['userid'] ?>">Kriteria Kecemerlangan</a></td>
        </tr>
