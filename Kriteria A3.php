 ...
 <table width="auto" align="center" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td width="350">        	<input name="save" type="submit" class="StyleTxtField2" id="save" value="Save" onclick="msg()" />
        	<button onclick="location.href = 'Kriteria A2.php' " type="button" class="StyleTxtField2">Back Page</button>
        	<button onclick="location.href = 'Kriteria A4.php' " type="button" class="StyleTxtField2">Next Page</button></td>
  </tr>
</table>
</form>
</div>
...
$PadamA3 = "<a href=\"/responsive/PadamA3.php?i=$a3_id &a=1\" onclick=\"return confirm('Padam')\">delete</a>";
$EditA3 = "<a href=\"/responsive/EditA3.php?i=$a3_id &a=2\" onclick=\"return confirm('Edit')\">edit</a>";




echo "<tr>";
echo "<td>$a3_id </td><td>$Anugerah</td><td>$Penglibatan</td><td>$Sijil</td><td>$PadamA3</td><td>$EditA3</td></td>";
