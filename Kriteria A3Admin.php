 ...
 <table width="auto" align="center" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td width="350">        	<input name="save" type="submit" class="StyleTxtField2" id="save" value="Save" onclick="msg()" />
        	<button onclick="location.href = 'Kriteria A2Admin.php' " type="button" class="StyleTxtField2">Back Page</button>
        	<button onclick="location.href = 'Kriteria A4Admin.php' " type="button" class="StyleTxtField2">Next Page</button></td>
  </tr>
</table>
</form>
</div>
        ...
        <div class="textarea"> <div class="box5">Penglibatan dalam Anugerah Inovasi /KIK.</div>
 <div class="box6">
...
if(isset($_SESSION['userid'])){
	...
	$sql = "SELECT * FROM a3 WHERE userid= '$userid' ORDER BY  a3_id ASC ";
...
$PadamA3Admin = "<a href=\"/responsive/PadamA3Admin.php?i=$a3_id &a=1\" onclick=\"return confirm('Padam')\">delete</a>";
$EditA3Admin = "<a href=\"/responsive/EditA3Admin.php?i=$a3_id &a=2\" onclick=\"return confirm('Edit')\">edit</a>";




echo "<tr>";
echo "<td>$a3_id </td><td>$Anugerah</td><td>$Penglibatan</td><td>$Sijil</td><td>$PadamA3Admin</td><td>$EditA3Admin</td></td>";
