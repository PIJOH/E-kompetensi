...
<div class="databox">
  <form id="form1" name="form1" method="post" action="A4pro.php">
...
<table width="auto" align="center" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td width="350">        	<input name="save" type="submit" class="StyleTxtField2" id="save" value="Save" onclick="msg()" />
        	<button onclick="location.href = 'Kriteria A3.php' " type="button" class="StyleTxtField2">Back Page</button>
        	<button onclick="location.href = 'Kriteria B.php' " type="button" class="StyleTxtField2">Next Page</button></td>
  </tr>
</table>
</form>
</div>
...
$PadamA4 = "<a href=\"/responsive/PadamA4.php?i=$a4_id &a=1\" onclick=\"return confirm('Padam')\">delete</a>";
$EditA4 = "<a href=\"/responsive/EditA4.php?i=$a4_id &a=2\" onclick=\"return confirm('Edit')\">edit</a>";




echo "<tr>";
echo "<td>$a4_id </td><td>$Penglibatan</td><td>$Status</td><td>$datepicker</td><td>$PadamA4</td><td>$EditA4</td></td>";
