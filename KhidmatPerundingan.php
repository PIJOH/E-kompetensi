...
<div class="databox">
  <form id="form1" name="form1" method="post" action="KhidmatPerundinganPro.php">
  ...
  <tr>
    <td width="350">        	<input name="save" type="submit" class="StyleTxtField2" id="save" value="Save" onclick="msg()" />
        	<button onclick="location.href = 'PenglibatanProjek.php' " type="button" class="StyleTxtField2">Back Page</button>
        	<button onclick="location.href = 'KhidmatNasihat.php' " type="button" class="StyleTxtField2">Next Page</button></td>
  </tr>
</table>
  </form>
</div>
...
$Padam7 = "<a href=\"/responsive/Padam7.php?i=$KhidmatPerundinganid &a=1\" onclick=\"return confirm('Padam')\">delete</a>";
$Edit7 = "<a href=\"/responsive/Edit7.php?i=$KhidmatPerundinganid &a=2\" onclick=\"return confirm('Edit')\">edit</a>";




echo "<tr>";
echo "<td>$NamaPerundingan</td><td>$Kementerian</td><td>$Jabatan</td><td>$Bidang</td><td>$Peringkat</td><td>$datepicker</td><td>$datepicker2</td><td>$DeskripsiDokumen</td><td>$Padam7</td><td>$Edit7</td></td>";
