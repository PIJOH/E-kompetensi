...
<div class="textarea">
<div class="databox">
  <form id="form1" name="form1" method="post" action="A1proAdmin.php">
 ...
 <table width="361" height="75" border="0" align="center" cellpadding="2" cellspacing="1">
  <tr>
    <td width="350">        	<input name="save" type="submit" class="StyleTxtField2" id="save" value="Save" onclick="msg()" />
        	<button onclick="location.href = 'Kriteria A2Admin.php' " type="button" class="StyleTxtField2">Next Page</button></td>
  </tr>
</table>
</form>
</div>
...
$PadamA1Admin = "<a href=\"/responsive/PadamA1Admin.php?i=$a1_id &a=1\" onclick=\"return confirm('Padam')\">delete</a>";
$EditA1Admin = "<a href=\"/responsive/EditA1Admin.php?i=$a1_id &a=2\" onclick=\"return confirm('Edit')\">edit</a>";
...
<td>$PadamA1Admin</td><td>$EditA1Admin</td>";
