...
<div class="databox">
  <form id="form1" name="form1" method="post" action="BidangKepakaranPro.php"><table width="auto" height="222" border="0" align="center" cellpadding="2" cellspacing="1">
  <tr>
  ...
  <tr>
    <td><input name="save" type="submit" class="StyleTxtField2" id="save" value="Save" />    	<button onclick="location.href = 'PenglibatanProjek.php' " type="button" class="StyleTxtField2">Next Page</button></td></td>
    <td>&nbsp;</td>
...
$Padam2 = "<a href=\"/responsive/Padam2.php?i=$BidangKepakaran_id&a=1\" onclick=\"return confirm('Padam')\">delete</a>";



echo "<tr>";
echo "<td>$PilihanPertama</td><td>$PilihanKedua</td><td>$PilihanKetiga</td><td>$Padam2</td>";
